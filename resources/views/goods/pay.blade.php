...
@section('content')
     ...
     <div class="dingdanlist" >
      <table>
       ...
       <tr>
        <td class="dingimg" width="15%"><img src="index/uploads/{{$data['goods_img']}}" /></td>
        <td width="50%">
         <h3>{{$data['goods_name']}}</h3>
         <time>下单时间：2019-04-20  10:28</time>
        </td>
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       ...
       <td width="40%"><a href="success?shop_price={{$data['shop_price']}}" class="jiesuan">提交订单</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
    </div><!--maincont-->
